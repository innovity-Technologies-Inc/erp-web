...
const PurchaseItemRow = ({ 
  control, register, index, remove, supplierId, setValue, errors, warehouses, allSelectedItems, trigger
}: { 
  control: any, register: any, index: number, remove: () => void, supplierId: number, setValue: any, errors: any, warehouses: any[], allSelectedItems: number[], trigger: any
}) => {
                  ...
                  <div className="relative">
                    <input 
                      ...
                      className={clsx(
                        ...
                        errors.chalan_no || chalanCheck?.chalan_no ? "border-rose-500 focus:ring-rose-500/10" : "border-gray-200 focus:ring-1 focus:ring-primary/30 focus:border-primary"
                      )} 
                    />
                ...
                <div className="md:col-span-4 space-y-1.5">
                  ...
                  <div className="relative">
                    <input 
                      ...
                      className={clsx(
                        "w-full h-[38px] px-3 bg-white border rounded-lg text-[13px] outline-none transition-all",
                        errors.batch_no || batchCheck?.batch_no ? "border-rose-500 focus:ring-rose-500/10" : "border-gray-200 focus:ring-1 focus:ring-primary/30 focus:border-primary"
                      )} 
                    />
