...
import { useInvoiceReturnDatatable } from '../../hooks/useReturn'
...
const tabs = [
  ...
  { name: 'Return From Merchant', to: '/inventory/return/merchant', active: true },
  { name: 'Wastage', to: '/inventory/return/wastage' },
]

export const MerchantReturnListPage = () => {
