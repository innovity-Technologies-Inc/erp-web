...
import { useSupplierReturnDatatable } from '../../hooks/useReturn'
...
const tabs = [
  { name: 'Return To Vendor', to: '/inventory/return/vendor', active: true },
  { name: 'Return From Merchant', to: '/inventory/return/merchant' },
  { name: 'Wastage', to: '/inventory/return/wastage' },
]

export const VendorReturnListPage = () => {
  ...
  const { data: returnData, isLoading } = useSupplierReturnDatatable(params)

  const handleCreate = () => {
    navigate({ to: '/inventory/return/vendor/create' })
  }
  ...
  const filterColumns = [
    ...
    { name: 'Vendor Name', field: 'vendorName', visible: visibleCols.vendorName },
