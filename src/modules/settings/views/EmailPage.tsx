...
export const EmailPage = () => {
  ...
  const tabs = useMemo(() => getSettingsTabs('/settings/email', isSuperAdmin), [isSuperAdmin])
  ...
  return (
    ...
    >
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-6 max-w-[1600px] mx-auto">
        ...
        <p className="text-sm text-gray-500">Placeholder for SMTP and email setting configurations.</p>
      </div>
    </ListPageLayout>
  )
}
