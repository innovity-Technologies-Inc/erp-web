...
import { TARGET_MODULE_OPTIONS } from './ApprovalWorkflowCreatePage'
...
export const ApprovalWorkflowEditPage = () => {
  const navigate = useNavigate()
  const { id } = useParams({ from: '/_authenticated/settings/approval-workflows/edit/$id' })
  ...
  useEffect(() => {
    if (detailsData?.data) {
      ...
      setRequiredApprovals(wf.required_approvals || '')
    ...
    saveWorkflow(payload, {
      onSuccess: (res: any) => {
        showNotificationModal(
          ...
          res.message || 'Approval workflow configuration has been updated.',
          'success'
        )
        navigate({ to: '/settings/approval-workflows' })
      },
  ...
  if (isLoadingDetails) {
    return (
      <div className="min-h-screen bg-[#f1f0f5] flex items-center justify-center p-8 font-poppins">
    ...
    <div className="min-h-screen bg-[#f1f0f5] pb-10 font-poppins text-[#475569]">
      ...
      <div className="max-w-[1600px] mx-auto pb-6">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-[20px] font-medium text-primary tracking-tight ml-2">Edit Approval Workflow</h1>
        </div>
      </div>
